...
/*
      ...
      NOTE: Only the tip of the chuck is required. The left vertical edge will
      be aligned with the right vertical edge of the HoodSketch.
 */

@SuppressWarnings("serial")
public class ColletSketch extends Sketch {
    static final int D1 = 0, D2 = 1;
    static final int L1 = 2, L2 = 3;
    public ColletSketch(SketchScene scene) {
        // For a "large" 1" dia collet
        super(new Dict("d1", 1.755, "d2", 1.14, "l1", .1, "l2", .7),
              scene);
    ...
    /**
       Get the maximum length along the centerline.
     */
    public double getAxialLength() {
        return specs.doubleAt("l2");
    }
    @Override
